...
function Banner() {
  return (
    <div role="banner" className='banner'>
      <div className='p-5 d-flex flex-row align-items-center vh-100 row'>
        <div className='col-12 col-sm-6 text-left pe-4'>
          ...
          <div className='d-flex flex-column flex-sm-row align-items-center'>
            <Link to={`/story`}><button type="button" className="btn btn-fantasy text-white me-4 p-4" data-mdb-ripple-color="#c33232"> Try Quest </button></Link>
            <Link to={`/practice`}><button type="button" className="btn btn-fantasy text-white me-4 p-4" data-mdb-ripple-color="#c33232"> Try Fighting  </button></Link>
            <Link to={`/login`}>Login ›</Link>
          </div>
        </div>
        <div className='col-12 col-sm-6 h-100 d-none d-sm-flex'>
