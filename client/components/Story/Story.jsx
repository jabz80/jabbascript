...
const Story = ({ incorrectAnswer, updateStory,storyMessageData,inputIncorrect }) => {
  ...
  return (
    <>
      ...
      {
        storyMessageData === dummyData[dummyData.length] ? (
          <p>Congratulations! You've reached the end of the story. Now you're ready to do battle</p>
        ) : (
          <p>{inputIncorrect ? "Ok let's try again" : storyMessageData}</p>
        )
      }
    </div>
      </div>
