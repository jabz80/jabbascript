    ...
    <div className='d-flex main-page-marketing-block main-page-marketing-block-bg-1 align-items-center'>
      ...
      <div className='col-4 ms-4'>
        ...
        <div className='d-flex bg-primary-subtle justify-content-center main-page-buttons align-items-center flex-column'>
          ...
          <div>
            <Link to='/story'><button type="button" className="btn btn-warning btn-lg me-4 shadow-sm" data-mdb-ripple-color="#c33232"> Try Story Mode </button></Link>
            <Link to='/fight'><button type="button" className="btn btn-warning btn-lg shadow-sm" data-mdb-ripple-color="#c33232"> Try Fighting Mode </button></Link>
          </div>
    </div>
